...
class Login313 extends StatelessWidget {
  Login313({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Padding(
            padding: EdgeInsets.fromLTRB(-18.6, -16.1, 0.0, 0.0),
            child: Stack(
              children: <Widget>[
                Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromPins(
                      Pin(size: 94.0, end: 23.9),
                      Pin(size: 48.3, start: 73.0),
                      child: Stack(
                        children: <Widget>[
                          Pinned.fromPins(
                    ...
                    Pinned.fromPins(
                      Pin(size: 78.0, start: 48.4),
                      Pin(size: 63.0, start: 142.0),
                      child: Text(
                        'Setting\n',
                        style: TextStyle(
                    ...
                    Pinned.fromPins(
                      Pin(start: 18.6, end: 0.0),
                      Pin(size: 257.2, middle: 0.7921),
                      child: Stack(
                        children: <Widget>[
                          Stack(
                            children: <Widget>[
                    ...
                    Pinned.fromPins(
                      Pin(start: 42.5, end: 23.9),
                      Pin(size: 70.4, end: 62.1),
                      child: Stack(
                        children: <Widget>[
                          Container(
                            decoration: BoxDecoration(
                    ...
                    Pinned.fromPins(
                      Pin(size: 33.0, middle: 0.1906),
                      Pin(size: 33.0, start: 104.8),
                      child: Stack(
                        children: <Widget>[
                          Center(
                            child: SizedBox(
                ...
                Pinned.fromPins(
                  Pin(size: 29.9, start: 45.6),
                  Pin(size: 18.3, middle: 0.0779),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                        Pin(start: 0.0, end: 0.0),
